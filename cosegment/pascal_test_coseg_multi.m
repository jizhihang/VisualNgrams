function pascal_test_coseg_multi(cachedir, cls, testset, year, suffix, modelname, postag)
...
disp(['pascal_test_coseg_multi(''' cachedir ''',''' cls ''',''' testset ''',''' year ''',''' suffix ''',''' modelname ''',''' postag ''');' ]);
...
resdir = [cachedir '/testFiles_coseg_' year '/']; mymkdir(resdir);
