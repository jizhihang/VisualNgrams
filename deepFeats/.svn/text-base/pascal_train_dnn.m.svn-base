...
try 
  ...
  model = train_dnn(model, impos, neg_small, false, false, 1, 5, ...
...
%%% debugging code
[mimg_lrs1, mlab_lrs1] = getMontagesForModel_latent_wsup(inds_parts, inds_parts, ...
    inds_parts, posscores_parts, posscores_parts, lbbox_parts, pos, [], n);
mimg = montage_list_w_text(mimg_lrs1, mlab_lrs1, 2, '', [0 0 0], [2000 2000 3]);
imwrite(mimg, [cachedir '/display/montage_parts.jpg']);
