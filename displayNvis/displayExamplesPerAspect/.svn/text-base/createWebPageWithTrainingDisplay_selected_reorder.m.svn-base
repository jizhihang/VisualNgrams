...
% this info is not really useful and not really needed in this script, for
% historical reason it is here and being left here as serves as a
% placeholder to check that this script has been run sucessfully (and need
% not be run again)
