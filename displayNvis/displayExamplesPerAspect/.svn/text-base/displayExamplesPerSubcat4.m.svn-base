function displayExamplesPerSubcat4(objname, outdir, VOCyear, traindatatype)
% displayExamplesPerSubcat3 + saving a 3x3 image

try    
disp(['displayExamplesPerSubcat4(''' objname ''',''' outdir ''',''' VOCyear ''',''' traindatatype ''')' ]);
