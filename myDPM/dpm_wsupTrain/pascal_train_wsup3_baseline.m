function model = pascal_train_wsup3_baseline(cls, n, note, cachedir, year, fg_olap, borderoffset, objname, fname_imgcl_sprNg, doparts)
    ...
    try        
        ...
        for i = 1:n
            ...
            if docomps(i) == 1                                
                ...
                % Train using several rounds of positive latent relabeling and data mining on the small set of negative images
