...
elseif length(varargin) == 4
    mcc('-m', func, '-a', varargin{1}, '-a', varargin{2}, '-a', varargin{3}, '-a', varargin{4});
elseif length(varargin) == 5
    mcc('-m', func, '-a', varargin{1}, '-a', varargin{2}, '-a', varargin{3}, '-a', varargin{4}, '-a', varargin{5});
elseif length(varargin) == 6
    mcc('-m', func, '-a', varargin{1}, '-a', varargin{2}, '-a', varargin{3}, '-a', varargin{4}, '-a', varargin{5}, '-a', varargin{6});
elseif length(varargin) > 6
